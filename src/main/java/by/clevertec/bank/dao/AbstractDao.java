...
import by.clevertec.bank.model.ThrowingBiConsumer;
import by.clevertec.bank.model.ThrowingConsumer;
import by.clevertec.bank.model.ThrowingFunction;
...
public abstract class AbstractDao<T extends AbstractDaoEntity> {
     ...
     */
    public abstract List<T> findAll(Connection connection) throws DaoException;
     ...
     */
    public abstract Optional<T> findById(Connection connection, long id) throws DaoException;
     ...
     */
    public abstract T create(Connection connection, T entity) throws DaoException;
     ...
     * @return The method is returning an object of type T.
     */
    public abstract T update(Connection connection, T entity) throws DaoException;
     ...
     */
    public abstract boolean deleteById(Connection connection, long id) throws DaoException;
     ...
     */
    public boolean delete(Connection connection, T entity) throws DaoException {
    ...
    protected long performPreparedUpdateReturn(Connection connection, String query,
    ...
    protected long performPreparedUpdateReturnId(Connection connection, String query,
                                                 ThrowingConsumer<PreparedStatement, SQLException> setter)
            throws SQLException {
        return performPreparedUpdateReturn(connection, query, (f, s) -> setter.accept(f), null, Statement.RETURN_GENERATED_KEYS);

    }

    protected long performPreparedUpdateReturnRows(Connection connection, String query,
                                                   ThrowingConsumer<PreparedStatement, SQLException> setter)
            throws SQLException {
        return performPreparedUpdateReturn(connection, query, (f, s) -> setter.accept(f), null, Statement.NO_GENERATED_KEYS);
    }

    protected <V> V performPreparedExecuteQuery(Connection connection, String query,
                                                ThrowingBiConsumer<PreparedStatement, T, SQLException> setter,
    ...
    protected <V> V performPreparedExecuteQuery(Connection connection, String query,
            ...
            throws SQLException {
        return performPreparedExecuteQuery(connection, query, (s, v) -> setter.accept(s), null, mapper);
    }

    protected <V> V performStatement(Connection connection, String query,
                                     ThrowingFunction<ResultSet, V, SQLException> mapper)
            throws SQLException {
