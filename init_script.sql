...
VALUES
    ('1111111111', NOW(), NOW(), 1, 1),
    ('1111111112', NOW(), NOW(), 2, 1);

INSERT INTO "bank_accounts" ("account", "open_date", "last_accrual_date", "bank_id", "user_id")
VALUES
    ('2222222221', NOW(), NOW(), 3, 2),
    ('2222222222', NOW(), NOW(), 4, 2);

INSERT INTO "bank_accounts" ("account", "open_date", "last_accrual_date", "bank_id", "user_id")
VALUES
    ('3333333331', NOW(), NOW(), 3, 3),
    ('3333333332', NOW(), NOW(), 4, 3);

INSERT INTO "bank_accounts" ("account", "open_date", "last_accrual_date", "bank_id", "user_id")
VALUES
    ('4444444441', NOW(), NOW(), 5, 4),
    ('4444444442', NOW(), NOW(), 1, 4);

INSERT INTO "bank_accounts" ("account", "open_date", "last_accrual_date", "bank_id", "user_id")
VALUES
    ('5555555551', NOW(), NOW(), 2, 5),
    ('5555555552', NOW(), NOW(), 3, 5);

INSERT INTO "bank_accounts" ("account", "open_date", "last_accrual_date", "bank_id", "user_id")
VALUES
    ('6666666661', NOW(), NOW(), 4, 6),
    ('6666666662', NOW(), NOW(), 5, 6);

INSERT INTO "bank_accounts" ("account", "open_date", "last_accrual_date", "bank_id", "user_id")
VALUES
    ('7777777771', NOW(), NOW(), 1, 7),
    ('7777777772', NOW(), NOW(), 2, 7);

INSERT INTO "bank_accounts" ("account", "open_date", "last_accrual_date", "bank_id", "user_id")
VALUES
    ('8888888881', NOW(), NOW(), 3, 8),
    ('8888888882', NOW(), NOW(), 4, 8);

INSERT INTO "bank_accounts" ("account", "open_date", "last_accrual_date", "bank_id", "user_id")
VALUES
    ('9999999991', NOW(), NOW(), 5, 9),
    ('9999999992', NOW(), NOW(), 1, 9);

INSERT INTO "bank_accounts" ("account", "open_date", "last_accrual_date", "bank_id", "user_id")
VALUES
    ('1010101011', NOW(), NOW(), 2, 10),
    ('1010101012', NOW(), NOW(), 3, 10);

INSERT INTO "bank_accounts" ("account", "open_date", "last_accrual_date", "bank_id", "user_id")
VALUES
    ('12111111111', NOW(), NOW(), 4, 11),
    ('12111111112', NOW(), NOW(), 5, 11);

INSERT INTO "bank_accounts" ("account", "open_date", "last_accrual_date", "bank_id", "user_id")
VALUES
    ('12121212121', NOW(), NOW(), 1, 12),
    ('12121212122', NOW(), NOW(), 2, 12);

INSERT INTO "bank_accounts" ("account", "open_date", "last_accrual_date", "bank_id", "user_id")
VALUES
    ('13131313131', NOW(), NOW(), 1, 13),
    ('13131313132', NOW(), NOW(), 2, 13);

INSERT INTO "bank_accounts" ("account", "open_date", "last_accrual_date", "bank_id", "user_id")
VALUES
    ('14141414141', NOW(), NOW(), 3, 14),
    ('14141414142', NOW(), NOW(), 4, 14);

INSERT INTO "bank_accounts" ("account", "open_date", "last_accrual_date", "bank_id", "user_id")
VALUES
    ('15151515151', NOW(), NOW(), 5, 15),
    ('15151515152', NOW(), NOW(), 1, 15);

INSERT INTO "bank_accounts" ("account", "open_date", "last_accrual_date", "bank_id", "user_id")
VALUES
    ('16161616161', NOW(), NOW(), 2, 16),
    ('16161616162', NOW(), NOW(), 3, 16);

INSERT INTO "bank_accounts" ("account", "open_date", "last_accrual_date", "bank_id", "user_id")
VALUES
    ('17171717171', NOW(), NOW(), 4, 17),
    ('17171717172', NOW(), NOW(), 5, 17);

INSERT INTO "bank_accounts" ("account", "open_date", "last_accrual_date", "bank_id", "user_id")
VALUES
    ('18181818181', NOW(), NOW(), 1, 18),
    ('18181818182', NOW(), NOW(), 2, 18);

INSERT INTO "bank_accounts" ("account", "open_date", "last_accrual_date", "bank_id", "user_id")
VALUES
    ('19191919191', NOW(), NOW(), 3, 19),
    ('19191919192', NOW(), NOW(), 4, 19);

INSERT INTO "bank_accounts" ("account", "open_date", "last_accrual_date", "bank_id", "user_id")
VALUES
    ('3939393939', NOW(), NOW(), 5, 20),
